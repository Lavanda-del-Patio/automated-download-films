...
public class RabbitMQConfig {
    ...
    public static final String QUEUE_MESSAGES = "agent-tmdb-feed-films-resolution";
    public static final String QUEUE_MESSAGES_DLQ = "agent-tmdb-feed-films-resolution-dlq";
